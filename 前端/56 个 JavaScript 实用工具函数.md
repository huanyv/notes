...
以下文章来源于前端充电宝 ，作者 CUGGZ
前端充电宝 .
来自：<https://mp.weixin.qq.com/s/n7t6G8sHzQgNPbnjuCjHEQ>
...
export const isIPv6 = (str) => {
    return Boolean(str.match(/:/g)?str.match(/:/g).length<=7:false && /::/.test(str)?/^([da-f] {1,4}(:|::)) {
        1,6
    }[da-f] {1,4}$/i.test(str):/^([da-f] {1,4}:) {
        7
    }[da-f] {1,4}$/i.test(str));
}
