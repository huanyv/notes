/**
 * Open Source Lib from https://github.com/45678/Base58
 * 
 ...
 * 
 * string encode  Base58.encode(new TextEncoder("UTF-8").encode("string"))
 * string decode  new TextDecoder("UTF-8").decode(Base58.decode("string"))
 */
